...
const SearchCategory = () => {
  ...
  return (
    <div className={`${
      darkMode ? 'text-white bg-[#1a1919]' : 'bg-white text-black'
    }   min-h-[400px] w-10/12 mx-auto p-6 shadow-lg rounded-md my-6`}>
      <h2 className={`${
      darkMode ? 'text-[#009877] ' : 'text-gray-800'
    } text-2xl font-bold  mb-4`}>Search Categories</h2>
      <input
        type="text"
